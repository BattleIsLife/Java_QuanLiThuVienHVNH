...
public class NhanVienForm extends JPanel {
	...
	public NhanVienForm(Nhanvien nv) {
		...
		this.nv = nv;
		if(!utilities.PermissionUtil.isAllowedToViewAsAdmin(nv, this))
		{
			return;
		}
		...
		scrollPane.setBounds(50, 282, 713, 239);
		add(scrollPane);
		
		table = new JTable();
		table.setShowHorizontalLines(true);
		table.setShowVerticalLines(true);
		String[] columnNames = {"Mã NV", "Tên NV", "Địa chỉ", "Email", "Ngày sinh", "SĐT", "Giới tính", "Chức vụ"};
		...
		lblGiiTnh.setBounds(49, 169, 132, 42);
		add(lblGiiTnh);
		...
		panel_1.setBounds(809, 258, 247, 263);
		add(panel_1);
	...
	private void FormLoad() {
		try {
			new controller.NhanVienController(this);
	...
	public void setBtnHienThi(JButton btnHienThi) {
